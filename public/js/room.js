...
function CopyClassText() {
    ...
    document.querySelector("#copyCode").textContent = "Copied!"
    setTimeout(()=>{
        document.querySelector("#copyCode").textContent = "Copy Code";
    }, 5000);
}
...
videoButt.addEventListener('click', () => {
    ...
    if (videoAllowed) {
        ...
        videoAllowed = 0;
        videoButt.style.backgroundColor = "#fa2a2a";
        ...
        videoAllowed = 1;
        videoButt.style.backgroundColor = "#0875ff";
        if (mystream) {
            mystream.getTracks().forEach(track => {
                if (track.kind === 'video')
                    track.enabled = true;
...
audioButt.addEventListener('click', () => {
    ...
    if (audioAllowed) {
        ...
        audioAllowed = 0;
        audioButt.style.backgroundColor = "#fa2a2a";
        if (mystream) {
            mystream.getTracks().forEach(track => {
                if (track.kind === 'audio')
                    track.enabled = false;
        ...
        audioAllowed = 1;
        audioButt.style.backgroundColor = "#0875ff";
        if (mystream) {
            mystream.getTracks().forEach(track => {
                if (track.kind === 'audio')
                    track.enabled = true;
